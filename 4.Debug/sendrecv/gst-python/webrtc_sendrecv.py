...
PIPELINE_DESC_H264 = WEBRTCBIN + '''
 ...
 queue ! 
 application/x-rtp,media=video,encoding-name=H264,payload={video_pt} ! 
 sendrecv.
 {asrc} ! 
 audioconvert ! 
 audioresample ! 
...
# Force I420 because dav1d bundled with Chrome doesn't support 10-bit chroma/luma (I420_10LE)
PIPELINE_DESC_AV1 = WEBRTCBIN + '''
 ...
 rtpav1pay ! 
 queue ! 
 application/x-rtp,media=video,encoding-name=AV1,payload={video_pt} ! 
 sendrecv.
 {asrc} ! 
 audioconvert ! 
 audioresample ! 
